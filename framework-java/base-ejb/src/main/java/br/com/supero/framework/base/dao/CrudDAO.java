...
public interface CrudDAO<ID extends Serializable, T extends BaseEntity<ID>, Q extends EntityPathBase<T>>
	 ...
	 * 
	 * */
	public DataPage<T> findListNamed(String namedQuery, String namedCount, Page page, Map<String, Object> params);
	 ...
	 */
	public DataPage<T> findList(CriteriaQuery<T> criteriaQuery, CriteriaQuery<Number> countQuery, Page page);
	
	/**
	 * Realiza uma busca parametrizada por uma lista de itens paginada utilizando criteria.
	 */
	public DataPage<T> findList(CriteriaQuery<T> criteriaQuery, CriteriaQuery<Number> countQuery, Page page, Map<String, Object> params);
	...
	public DataPage<T> findQ(Q qEnt, Predicate pred, Page page, List<Expression<?>> expLst, OrderSpecifier<?>[] order);
